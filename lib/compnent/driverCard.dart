...
import 'package:bit_vehicle_web/compnent/dispatcher/driverProfile.dart';
...
class driverCard extends StatelessWidget {
  ...
  const driverCard({Key? key, required this.doc}) : super(key: key);
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) =>  driverProfile(doc)));
      },
      child: Container(
        height: 65,
